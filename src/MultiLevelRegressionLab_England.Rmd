...
\textcolor{violet}{The Bayesian p-value of `r MCMCvis::MCMCchains(zc_pooled_check, params = c("p_val_min")) %>% mean() %>% scales::comma(accuracy = 0.01)` indicates poor fit for the minimum of $\textrm{N} _2 \textrm{O}$ emissions. This is probably acceptable because the minimum value is an extreme value on the distribution.}
