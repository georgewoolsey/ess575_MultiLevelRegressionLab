...
ggplot(data = .) +
  ...
  xlab("Mean Observed log(Emissions)") +
  ylab("Mean Simulated log(Emissions)") +
  labs(
    title = "Observed vs. Simulated log(Emissions) - Mean"
    , subtitle = paste0(
        "*Bayesian P value = "
...
ggplot(data = .) +
  ...
  xlab("St. Dev. Observed log(Emissions)") +
  ylab("St. Dev. Simulated log(Emissions)") +
  labs(
    title = "Observed vs. Simulated log(Emissions) - St. Dev."
    , subtitle = paste0(
        "*Bayesian P value = "
...
ggplot(data = .) +
  ...
  #   , breaks = scales::extended_breaks(n=10)
  # ) +
  xlab("Minimum Observed log(Emissions)") +
  ylab("Minimum Simulated log(Emissions)") +
  labs(
    title = "Observed vs. Simulated log(Emissions) - Minimum"
    , subtitle = paste0(
        "*Bayesian P value = "
...
ggplot(data = .) +
  ...
  xlab("SSE Observed log(Emissions)") +
  ylab("SSE Simulated log(Emissions)") +
  labs(
    title = "Observed vs. Simulated log(Emissions) - Sum of Squared Errors"
    , subtitle = paste0(
        "*Bayesian P value = "
