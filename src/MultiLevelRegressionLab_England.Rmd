...
```{r, echo=FALSE, out.width="60%", out.height="60%", fig.cap="", fig.align='center'}
knitr::include_graphics("../data/eq2.jpg")
```

Joint:

*$\rho$ = coefficient of correlation = $-1 \le \rho \le 1$*
...
Simulate a new data set at each iteration of the MCMC. This sounds formidable, but it is really no more than drawing a random variable from the likelihood. You can simulate a new data set by embedding the following code in the same `for` loop as your likelihood. For example:
